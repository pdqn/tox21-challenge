...
for target in y_tr.columns:
    ...
    print y_tr[target][rows_tr].shape
    print x_tr_dense[rows_tr].shape
    print target
    #print y_tr[target][rows_tr]
...
## AUC - 0.789
##801 features before adding sparse - 1644 features after adding the sparse ones